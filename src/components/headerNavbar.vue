<template>
  <div
    v-if="
      $route.path === 'register' ? (ShowNavBar = false) : (ShowNavBar = true)
    "
    class="py-[24px]"
  >
  ...
  <div class="modal-overlay bg-[#00000080] items-center justify-center">
    <Transition>
      <div
        class="sm:w-[490px] smm:w-[450px] xss:w-[365px] w-[586px] py-[28px] px-[28px] bg-[#FFF] rounded-[12px]"
      >
        ...
        <form action="" class="flex flex-col justify-center">
          ...
          >
            <option class="" value="0">Barchasi</option>
            <hr />
            <option class="" value="1">Yangi</option>
            <hr />
            <option class="" value="2">Moderatsiyada</option>
            <hr />
            <option class="" value="3">Tasdiqlangan</option>
            <hr />
            <option class="" value="4">Bekor qilingan</option>
          </select>
          <label
            for=""
          ...
          >
          <div
            class="grid grid-cols-4 sm:grid-cols-3 xss:grid-cols-2 gap-[16px] pt-[12px]"
          >
            <label
...
export default {
  ...
  methods: {
    ...
    filterClickHandler(e) {
      ...
      const data = {
        id: this.searchSelect,
        searchData: this.searchData,
        sumsId: this.currentSum,
      };
